  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
        <img src="./img/Aditya-designstyle-kiddo-m.png" id="navlogo" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/aditya.gunale.79"
            ...
            <li>
              <a
                href="https://www.instagram.com/_aditya_reddy_45/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/aditya-gunale-541317180/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Aditya Gunale</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
